...
The optimal value of :math:`\eta` for corrected trajectories is found by minimizing the logarithmic velocity of the 
corrected trajectory:

:math: \rightarrow min `|\eta\frac{dU}{d\eta}|`

Corrected trajectories are already computed when one obtains an :class:`~pyopencap.analysis.EigenvalueTrajectory`
...
find the optimal value of the CAP strength parameter `\eta_{opt}`. The :class:`~pyopencap.analysis.EigenvalueTrajectory`
...
:math: \rightarrow min `|\eta\frac{dE}{d\eta}|`
...
:func:`~pyopencap.analysis.EigenvalueTrajectory.get_derivatives` returns the value of 
