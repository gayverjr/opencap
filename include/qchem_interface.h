...
/*! Read in TDMs from Q-Chem .fchk file
    \param std::string dmat_filename: file location of the Q-Chem .fchk file
    \param size_t nstates: number of states
    \param size_t num_bf: number of basis functions
...
/*! Read in energies from Q-Chem .fchk file
    \param size_t nstates: number of states,
    \param std::string method: electronic structure method method,
    \param std::string output_file: qchem .fchk file location
